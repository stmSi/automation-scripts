...
SESSION_NAME="vnext-apps"
TARGET_DIR="/home/stm/work/platform-shared-tools/packages/deployment/docker-compose-apps"
...
tmux new-session -d -s "$SESSION_NAME" -n "vnext-apps" -c "$TARGET_DIR"
