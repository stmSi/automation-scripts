...
SESSION_NAME="vnext-infra"
TARGET_DIR="/home/stm/work/platform-shared-tools/packages/deployment/docker-compose-infra"
...
tmux new-session -d -s "$SESSION_NAME" -n "vnext-infra" -c "$TARGET_DIR"
