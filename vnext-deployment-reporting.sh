...
SESSION_NAME="vnext-reporting"
TARGET_DIR="/home/stm/work/platform-shared-tools/packages/deployment/docker-compose-reporting"
...
tmux new-session -d -s "$SESSION_NAME" -n "vnext-reporting" -c "$TARGET_DIR"
